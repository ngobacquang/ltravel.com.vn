...
public partial class cms_admin_Moduls_DuyetTin_Item_BaiVietDaDuyet : System.Web.UI.UserControl
{
  ...
  {
    string key = "modul=" + modul + "&user=" + user + "&title=" + title + "&DateFrom=" + DateFrom + "&DateTo=" + DateTo + "&NumberShowItem=" + NumberShowItem;
    Response.Redirect(UrlExtension.WebisteUrl + "/admin.aspx?uc=DuyetTin&suc=BaiVietDaDuyet&p=1&" + key);
  }
}