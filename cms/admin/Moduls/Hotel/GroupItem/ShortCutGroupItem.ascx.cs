...
public partial class cms_admin_Moduls_Hotel_GroupItem_ShortCutGroupItem : System.Web.UI.UserControl
{
  ...
  void GetGroupsProductInDdl()
  {
    ...
    condition = DataExtension.AndConditon(GroupsTSql.GetGroupsByVglang(language), GroupsTSql.GetGroupsByVgapp(CodeApplications.Hotel), " igenable <> '2' ");
  ...
  protected void btOK_Click(object sender, EventArgs e)
  {
    ...
    if (insert)
    {
      ...
      Groups.InsertGroups(language, app, "", tbTitle.Text, tbDesc.Text, "", "", "", "", "", "", DdlGroupProduct.SelectedValue, "", "", image, DdlPosition.SelectedValue, tbMaxItem.Text, tbOrder.Text, DateTime.Now.ToString(), DateTime.Now.ToString(), DateTime.Now.ToString(), status);
    ...
    else
    {
      ...
      Groups.UpdateGroups(language, app, tbTitle.Text, tbDesc.Text, "", "", "", "", "", "", DdlGroupProduct.SelectedValue, "", "", image, DdlPosition.SelectedValue, tbMaxItem.Text, tbOrder.Text, DateTime.Now.ToString(), DateTime.Now.ToString(), DateTime.Now.ToString(), status, igid);
