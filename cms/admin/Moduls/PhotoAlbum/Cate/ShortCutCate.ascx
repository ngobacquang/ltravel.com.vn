...
<div id="ShortCutCate">
  ...
  <div class="pdControl">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.PhotoAlbumKeyword.DanhMucCha %></div>
    </div>
    <div class="control">
      <asp:DropDownList ID="DdlGroupPhotoAlbum" runat="server" Width="252px"></asp:DropDownList>
    </div>
    <div class="cbh8">
      <!---->
    </div>
    <div class="text">
      <div class="pt8"><%=Developer.PhotoAlbumKeyword.TenDanhMuc%></div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.PhotoAlbumKeyword.MoTa%>:</div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.PhotoAlbumKeyword.ThuTu %>:</div>
    </div>
    <div class="control">
    ...
    <div class="KhungToiUu PdKhungToiUu">
      ...
      <div>
        <div class="text">
          <div class="pt8"><%=Developer.PhotoAlbumKeyword.ToiUuDuongDan%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.PhotoAlbumKeyword.ToiUuTheTieuDe%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.PhotoAlbumKeyword.ToiUuTheTuKhoa%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.PhotoAlbumKeyword.ToiUuTheMoTa%>: </div>
        </div>
        <div class="control">
    ...
    <div class="text">
      <div class="pt5"><%=Developer.PhotoAlbumKeyword.TrangThai %>:</div>
    </div>
    <div class="control">
      <div>
