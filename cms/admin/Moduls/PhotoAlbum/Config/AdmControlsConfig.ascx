...
<div id="AdmControlsConfig">
  ...
  <div class="fl pl20 pt3">Số <%=Developer.PhotoAlbumKeyword.PhotoAlbum2 %> trên trang chủ:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoPhotoAlbumTrenTrangChu" Height="22" runat="server"></asp:TextBox>
  ...
  <div class="fl pl20 pt3">Số <%=Developer.PhotoAlbumKeyword.PhotoAlbum2 %> trên trang danh mục:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoPhotoAlbumTrenTrangDanhMuc" Height="22" runat="server"></asp:TextBox>
  ...
  <div class="fl pl20 pt3">Số <%=Developer.PhotoAlbumKeyword.PhotoAlbum2 %> khác trên một trang:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoPhotoAlbumKhacTrenMotTrang" Height="22" runat="server"></asp:TextBox>
