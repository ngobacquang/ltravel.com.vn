...
<div id="admscitem">
  ...
  <div class="text">
    <div class="pt8"><%=PhotoAlbumKeyword.DanhMucCha%></div>
  </div>
  <div class="control">
  ...
  <div class="text">
    <div class="pt8"><%=PhotoAlbumKeyword.TieuDe%></div>
  </div>
  <div class="control">
  ...
  <div class="text">
    <div class="pt8"><%=PhotoAlbumKeyword.Ma%></div>
  </div>
  <div class="control">
  ...
  <div class="text">
    <div class="pt8"><%=PhotoAlbumKeyword.MoTa%></div>
  </div>
  <div class="box">
  ...
  <div class="text">
    <div class="pt8"><%=PhotoAlbumKeyword.NgayDang%></div>
  </div>
  <div>
  ...
  <div class="text">
    <div class="pt8"><%=PhotoAlbumKeyword.ThuTu%></div>
  </div>
  <div class="control">
  ...
  <div class="dn">
    ...
    <div class="text">
      <div class="pt8"><%=PhotoAlbumKeyword.MoTaHinhAnh%></div>
    </div>
    <div class="box">
  ...
  <div>
    <CKEditor:CKEditorControl ID="txt_content" runat="server" FilebrowserImageBrowseUrl="ckeditor/ckfinder/ckfinder.aspx?type=Images&path=pic/PhotoAlbum"></CKEditor:CKEditorControl>
  </div>
  <div class="cbh10">
    <!---->
  </div>
  ...
  <div class="KhungToiUu PdKhungToiUu">
    ...
    <div>
      <div class="text">
        <div class="pt8"><%=PhotoAlbumKeyword.ToiUuTheTieuDe%> </div>
      </div>
      <div class="control1">
      ...
      <div class="text">
        <div class="pt8"><%=PhotoAlbumKeyword.ToiUuDuongDan%> </div>
      </div>
      <div class="control1">
      ...
      <div class="text">
        <div class="pt8"><%=PhotoAlbumKeyword.ToiUuTheTuKhoa%> </div>
      </div>
      <div class="control1">
      ...
      <div class="text">
        <div class="pt8"><%=PhotoAlbumKeyword.ToiUuTheMoTa%> </div>
      </div>
      <div class="control1">
      ...
      <div class="dn">
        <div class="text">
          <div class="pt8"><%=PhotoAlbumKeyword.Tag%> </div>
        </div>
        <div class="control1">
