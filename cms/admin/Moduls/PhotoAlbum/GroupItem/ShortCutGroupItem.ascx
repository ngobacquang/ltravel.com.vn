...
<div id="admsccate">
  ...
  <div class="pdControl">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.PhotoAlbumKeyword.ViTri%></div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.PhotoAlbumKeyword.TenNhom %></div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.PhotoAlbumKeyword.SoPhotoAlbumDuocHienThi %>:</div>
    </div>
    <div class="control">
