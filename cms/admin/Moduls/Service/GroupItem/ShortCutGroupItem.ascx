...
<div id="admsccate">
  ...
  <div class="pdControl">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.ServiceKeyword.ViTri%></div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.ServiceKeyword.TenNhom %></div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.ServiceKeyword.SoServiceDuocHienThi %>:</div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.ServiceKeyword.TrangThai %>:</div>
    </div>
    <div class="control">
      <div>
