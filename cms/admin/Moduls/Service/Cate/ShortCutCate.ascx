...
<div id="ShortCutCate">
  ...
  <div class="pdControl">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.ServiceKeyword.DanhMucCha %></div>
    </div>
    <div class="control">
      <asp:DropDownList ID="DdlGroupService" runat="server" Width="252px"></asp:DropDownList>
    </div>
    <div class="cbh8">
      <!---->
    </div>
    <div class="text">
      <div class="pt8"><%=Developer.ServiceKeyword.TenDanhMuc%></div>
    </div>
    <div class="control">
      <asp:TextBox ID="txt_title_modul" runat="server" Width="600px" CssClass="tbTitle"></asp:TextBox>
    ...
    <div class="text">
      <div class="pt8"><%=Developer.ServiceKeyword.MoTa%>:</div>
    </div>
    <div class="control">
      <asp:TextBox ID="txtDesc" runat="server" Width="600px" Height="50px" TextMode="MultiLine" CssClass="tbDesc"></asp:TextBox>
    </div>
    <div class="dn">
      <div class="cbh8">
        <!---->
    ...
    <div class="text">
      <div class="pt8"><%=Developer.ServiceKeyword.ThuTu %>:</div>
    </div>
    <div class="control">
    ...
    <div class="dn">
      ...
      <div>
        <CKEditor:CKEditorControl ID="txt_content" runat="server" FilebrowserImageBrowseUrl="ckeditor/ckfinder/ckfinder.aspx?type=Images&path=pic/Service"></CKEditor:CKEditorControl>
      </div>
      <div class="cbh10">
        <!---->
      </div>
    ...
    <div class="KhungToiUu PdKhungToiUu">
      ...
      <div>
        <div class="text">
          <div class="pt8"><%=Developer.ServiceKeyword.ToiUuDuongDan%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.ServiceKeyword.ToiUuTheTieuDe%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.ServiceKeyword.ToiUuTheTuKhoa%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.ServiceKeyword.ToiUuTheMoTa%>: </div>
        </div>
        <div class="control">
    ...
    <div class="text">
      <div class="pt5"><%=Developer.ServiceKeyword.TrangThai %>:</div>
    </div>
    <div class="control">
      <div>
