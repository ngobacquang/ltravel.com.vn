...
public partial class cms_admin_Moduls_Service_Item_ShortCutItem : System.Web.UI.UserControl
{
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    ...
    if (!IsPostBack)
    {
      ltrTrangThai.Text = "<div class='text pt2'>" + Developer.ServiceKeyword.TrangThai + @"</div>";
  ...
  private string LinkRedrect()
  {
    ...
    {
      return UrlExtension.WebisteUrl + "admin.aspx?uc=" + CodeApplications.Service + "&suc=" + TypePage.Item + "&ni=" + ni + "&p=" + p;
    }
    else
    {
      return UrlExtension.WebisteUrl + "admin.aspx?uc=" + CodeApplications.Service + "&suc=" + TypePage.Item;
    }
  }
  ...
  void InitialControlsValue(bool insert)
  {
    ...
    if (!insert)
    {
      ...
      tbDanhSachTepDinhKem.Text = dt.Rows[0][ItemsColumns.ViparamsColumn].ToString();
