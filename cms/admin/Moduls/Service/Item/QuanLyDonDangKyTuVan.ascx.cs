...
public partial class cms_admin_Moduls_Service_Item_QuanLyDonDangKyTuVan : System.Web.UI.UserControl
{
  ...
  protected string LinkUpdate(string iid)
  {
    ...
    {
      return LinkAdmin.GoAdminItem(app, "QuanLyDonDangKyTuVan", iid, NumberShowItem, p);
    }
    else
    {
      return LinkAdmin.GoAdminItem(app, "QuanLyDonDangKyTuVan", iid);
    }
  }
  ...
  {
    string igidUpdate = "";
    return LinkAdmin.GoAdminCategory(app, "QuanLyDonDangKyTuVan", igidUpdate);
  }
  ...
  void GetNews(string order)
  {
    ...
    LtPagging.Text = PagingExtension.SpilitPages(Convert.ToInt32(dt.Rows[0]["TotalRows"]),
                                                  ...
                                                  LinkAdmin.UrlAdmin(CodeApplications.Service, "QuanLyDonDangKyTuVan",
                                                               "", key,
  ...
  {
    string key = tbKeySearch.Text + "&name=" + tbTitleSearch.Text;
    Response.Redirect(LinkAdmin.GoAdminCategory(app, "QuanLyDonDangKyTuVan", "",
