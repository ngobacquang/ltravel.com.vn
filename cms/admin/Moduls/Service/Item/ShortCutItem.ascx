...
<div id="admscitem">
  ...
  <div class="text">
    <div class="pt8"><%=ServiceKeyword.DanhMucCha%></div>
  </div>
  <div class="control">
  ...
  <div class="text">
    <div class="pt8"><%=ServiceKeyword.TieuDe%></div>
  </div>
  <div class="control">
  ...
  <div class="text">
    <div class="pt8"><%=ServiceKeyword.Ma%></div>
  </div>
  <div class="control">
  ...
  <div class="text">
    <div class="pt8"><%=ServiceKeyword.MoTa%></div>
  </div>
  <div class="box">
  ...
  <div class="text">
    <div class="pt8"><%=ServiceKeyword.NgayDang%></div>
  </div>
  <div>
  ...
  <div class="text">
    <div class="pt8"><%=ServiceKeyword.ThuTu%></div>
  </div>
  <div class="control">
  ...
  <div class="dn">
    ...
    <div class="text">
      <div class="pt8"><%=ServiceKeyword.MoTaHinhAnh%></div>
    </div>
    <div class="box">
  ...
  <div style="display: none">
    ...
    <div class="text">
      <div class="pt8">Danh sách tệp đính kèm</div>
    </div>
    <div class="box">
      ...
      <div style="background: #fff; padding: 10px; margin-top: 5px; line-height: 20px; box-shadow: inset 0 0 0 1px #dfdfdf">
        Hướng dẫn: Bạn qua phần quản lý danh sách tài liệu &rarr; Copy ID của tài liệu &rarr; paste vào ô trên, mỗi ID paste trên một dòng (Xem ví dụ ở hình dưới).
                <ul>
                  <li>Copy ID<br />
                    <img src="cms/admin/moduls/FileLibrary/Item/ControlItem/idtailieu.png" /></li>
                  <li>Paste ID vào ô trên<br />
                    <img src="cms/admin/moduls/FileLibrary/Item/ControlItem/pasteid.png" /></li>
                </ul>
      </div>
    </div>
  </div>
  ...
  <div class="KhungToiUu PdKhungToiUu">
    ...
    <div>
      <div class="text">
        <div class="pt8"><%=ServiceKeyword.ToiUuTheTieuDe%> </div>
      </div>
      <div class="control1">
      ...
      <div class="text">
        <div class="pt8"><%=ServiceKeyword.ToiUuDuongDan%> </div>
      </div>
      <div class="control1">
      ...
      <div class="text">
        <div class="pt8"><%=ServiceKeyword.ToiUuTheTuKhoa%> </div>
      </div>
      <div class="control1">
      ...
      <div class="text">
        <div class="pt8"><%=ServiceKeyword.ToiUuTheMoTa%> </div>
      </div>
      <div class="control1">
      ...
      <div class="dn">
        <div class="text">
          <div class="pt8"><%=ServiceKeyword.Tag%> </div>
        </div>
        <div class="control1">
