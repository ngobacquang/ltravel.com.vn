...
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
  <link href="~/cms/admin/Moduls/Service/Item/ControlItem/_cs.css" rel="stylesheet" type="text/css" />
        ...
        <div class="Item" id="Item-<%#Eval("IID").ToString()%>">
          <div class="bgItem box-post">
            ...
            <div class="fr tool pr5 box-cc cot7">
              <a class="<%=ServiceConfig.KeyHienThiQuanLyPhanHoiDichVu %> <%=keyHide %>" href="javascript:NewWindow_('cms/admin/Moduls/Service/Item/PopUp/ViewComments.aspx?iid=<%#Eval("IID")%>','ImageList','950','600','yes','yes')"><span class='iconPhanHoi'>
                <!---->
              </span></a>

              <a class="<%=TagConfig.KeyHienThiTagChoService%> <%=keyHide %>" title="Click để thêm tag" href="javascript:NewWindow_('cms/admin/TempControls/PopUp/Items/AddTags.aspx?iid=<%#Eval("IID")%>&Modul=<%=app %>','ImageList','950','600','yes','yes')"><span class='iconThemTag'>
                <!---->
              </span></a>

              <div class="dn">
                <a class=" <%=keyHide %>" title="<%=Developer.ServiceKeyword.ClickDeThemVaoNhom %>" href="javascript:NewWindow_('cms/admin/Moduls/Service/Item/Popup/AddItemToGroups.aspx?iid=<%#Eval("IID")%>','ImageList','800','450','yes','yes')"><span class='iconThemVaoNhom'>
                  <!---->
                </span></a>
              </div>
