<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuanLyBaiVietDaXuatBan.ascx.cs" Inherits="cms_admin_Moduls_Service_Item_DuyetTin_QuanLyBaiVietDaXuatBan" %>
        ...
        <div class="Item" id="Item-<%#Eval("IID").ToString()%>">
          <div class="bgItem box-post">
            ...
            <div class="fr tool pr5 cot7 box-cc">
              <a class="<%=ServiceConfig.KeyHienThiQuanLyPhanHoiDichVu %>" href="javascript:NewWindow_('cms/admin/Moduls/Service/Item/PopUp/ViewComments.aspx?iid=<%#Eval("IID")%>','ImageList','950','600','yes','yes')"><span class='iconPhanHoi'>
                <!---->
              </span></a>

              <a class="<%=TagConfig.KeyHienThiTagChoService%>" title="Click để thêm tag" href="javascript:NewWindow_('cms/admin/TempControls/PopUp/Items/AddTags.aspx?iid=<%#Eval("IID")%>&Modul=<%=app %>','ImageList','950','600','yes','yes')"><span class='iconThemTag'>
                <!---->
              </span></a>

              <div class="dn">
                <a title="<%=Developer.ServiceKeyword.ClickDeThemVaoNhom %>" href="javascript:NewWindow_('cms/admin/Moduls/Service/Item/Popup/AddItemToGroups.aspx?iid=<%#Eval("IID")%>','ImageList','800','450','yes','yes')"><span class='iconThemVaoNhom'>
                  <!---->
                </span></a>
              </div>
