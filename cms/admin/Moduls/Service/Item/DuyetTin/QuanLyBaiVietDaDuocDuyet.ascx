<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuanLyBaiVietDaDuocDuyet.ascx.cs" Inherits="cms_admin_Moduls_Service_Item_DuyetTin_QuanLyBaiVietDaDuocDuyet" %>
