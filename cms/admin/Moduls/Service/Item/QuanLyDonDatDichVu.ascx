<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuanLyDonDatDichVu.ascx.cs" Inherits="cms_admin_Moduls_Service_Item_QuanLyDonDatDichVu" %>
...
<div id="admitem">
  ...
  <div class="BgTabTitle box-post" align="center">
    ...
    <div class="cot2" align="left">
      <asp:LinkButton ID="lbtName" runat="server" OnClick="lbtName_Click" CssClass="arrowSort" ToolTip="Click để sắp xếp danh sách theo trường này">Thông tin đơn đặt dịch vụ</asp:LinkButton>
    </div>
    <div class="split">|</div>
      ...
      <ItemTemplate>
        <div id="Item-<%#Eval("IID").ToString()%>">
          <div class="bgItem box-post">
            ...
            <div class="split">|</div>
            <div class="cot2" align="left">
              <div class="pt5">- <b>Tiêu đề:</b> Đơn đăng ký dịch vụ <b><%#Eval("VITITLE").ToString() %></b></div>
              <div class="pt5">- <b>Họ tên:</b> <%#Eval("VIAUTHOR").ToString() %></div>
              <div class="pt5">- <b>Điện thoại:</b> <%#StringExtension.LayChuoi(Eval("VIPARAMS").ToString(),"",1)%></div>
              <div class="pt5">- <b>Email:</b> <%#StringExtension.LayChuoi(Eval("VIPARAMS").ToString(),"",2)%></div>
              <div class="pt5">- <b>Quốc tịch:</b> <%#StringExtension.LayChuoi(Eval("VIPARAMS").ToString(),"",3)%></div>
            </div>
            <div class="split">|</div>
            ...
            <div class="fr tool pr5 cot7 box-cc">
              <a title='Click để xem chi tiết đơn này' href="javascript:void(0)" onclick="NewWindow_('cms/admin/Moduls/Service/Item/Popup/ViewDetail.aspx?iid=<%#Eval("IID")%>','ImageList','900','500','yes','yes')"><span class='iconInfo'>
                <!---->
              </span></a>
