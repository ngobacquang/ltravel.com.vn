...
<div id="admsccate">
  ...
  <div class="pdControl">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.ProductKeyword.DanhMucCha %></div>
    </div>
    <div class="control">
      <asp:DropDownList ID="DdlGroupProduct" runat="server" Width="252px"></asp:DropDownList>
    </div>
    <div class="cbh8">
      <!---->
    </div>
    <div class="text">
      <div class="pt8"><%=Developer.ProductKeyword.TenDanhMuc%></div>
    </div>
    <div class="control">
