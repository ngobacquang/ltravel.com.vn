...
<div id="admsccate">
  ...
  <div class="pdControl">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.ProductKeyword.ViTri%></div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8">Nhóm cha</div>
    </div>
    <div class="control">
      <asp:DropDownList ID="DdlGroupGroups" runat="server" Width="252px"></asp:DropDownList>
    </div>
    <div class="cbh8">
      <!---->
    </div>
    <div class="text">
      <div class="pt8"><%=Developer.ProductKeyword.TenNhom %></div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.ProductKeyword.MoTa%>:</div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8">Link tới danh mục</div>
    </div>
    <div class="control">
      <asp:DropDownList ID="DdlGroupProduct" ClientIDMode="Static" runat="server" Width="252px"></asp:DropDownList>
    </div>
    <div class="cbh8">
      <!---->
    </div>
    <div class="text">
      <div class="pt8">Link tùy chọn:</div>
    </div>
    <div class="control">
      <asp:TextBox ID="tbLinkUrl" ClientIDMode="Static" runat="server" Width="580px" CssClass="tbTitle"></asp:TextBox>
    </div>
    <div class="cbh8">
      <!---->
    </div>
    <div class="text">
      <div class="pt8"><%=Developer.ProductKeyword.SoProductDuocHienThi %>:</div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.ProductKeyword.ThuTu %>:</div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.ProductKeyword.AnhDaiDien%>:</div>
    </div>
    ...
    <div class="KhungToiUu PdKhungToiUu">
      ...
      <div>
        <div class="text">
          <div class="pt8"><%=Developer.ProductKeyword.ToiUuDuongDan%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.ProductKeyword.ToiUuTheTieuDe%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.ProductKeyword.ToiUuTheTuKhoa%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.ProductKeyword.ToiUuTheMoTa%>: </div>
        </div>
        <div class="control">
    ...
    <div class="text">
      <div class="pt5"><%=Developer.ProductKeyword.TrangThai %>:</div>
    </div>
    <div class="control">
      <div>
