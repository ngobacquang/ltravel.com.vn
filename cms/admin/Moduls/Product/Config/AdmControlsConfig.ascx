...
<div id="AdmControlsConfig">
  ...
  <div class="fl pl20 pt3">Số <%=ProductKeyword.Product2 %> trên trang chủ:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoProductTrenTrangChu" Height="22" runat="server"></asp:TextBox>
  ...
  <div class="fl pl20 pt3">Số <%=ProductKeyword.Product2 %> trên trang danh mục:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoProductTrenTrangDanhMuc" Height="22" runat="server"></asp:TextBox>
  ...
  <div class="fl pl20 pt3">Số <%=ProductKeyword.Product2 %> khác trên một trang:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoProductKhacTrenMotTrang" Height="22" runat="server"></asp:TextBox>
  ...
  <div class="dn">
    ...
    <div class="fwb pb10">Cấu hình nội dung</div>
    <div class="pl20">Nội dung cuối trang danh mục sản phẩm:</div>
    <div class="pl20 pt10">
