<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuanLyBaiVietDaXuatBan.ascx.cs" Inherits="cms_admin_Moduls_Product_Item_DuyetTin_QuanLyBaiVietDaXuatBan" %>
...
<div id="admitem">
  ...
  <div class="BgTabTitle box-post" align="center">
    ...
    <div class="split">|</div>
    <div class="cot5"><%=Developer.ProductKeyword.TrangThai %></div>
    <div class="split">|</div>
        ...
        <div class="Item" id="Item-<%#Eval("IID").ToString()%>">
          <div class="bgItem box-post">
            ...
            <div class="fr tool pr5 cot7 box-cc">
              <a class="<%=ProductConfig.KeyHienThiQuanLyPhanHoiSanPham %>" href="javascript:NewWindow_('cms/admin/Moduls/Product/Item/PopUp/ViewComments.aspx?iid=<%#Eval("IID")%>','ImageList','1000','650','yes','yes')"><span class='iconPhanHoi'>
                <!---->
              </span></a>
              <a class="<%=ProductConfig.KeyHienThiThemNhieuBaiVietChoSanPham %>" title="<%=Developer.ProductKeyword.ClickDeThemBaiViet %>" href="javascript:NewWindow_('cms/admin/Moduls/Product/Item/PopUp/AddNewsToItems.aspx?iid=<%#Eval("IID")%>','ImageList','1000','650','yes','yes')"><span class='iconThemBaiViet'>
                <!---->
              </span></a>
              <a class="<%=ProductConfig.KeyHienThiThemNhieuAnhChoSanPham %>" title="<%=Developer.ProductKeyword.ClickDeThemHinhAnh %>" href="javascript:NewWindow_('cms/admin/Moduls/Product/Item/PopUp/AddPictureToItems.aspx?iid=<%#Eval("IID")%>','ImageList','1000','650','yes','yes')"><span class='iconThemAnh'>
                <!---->
              </span></a>
              <a class="<%=ProductConfig.KeyHienThiThemNhieuVideoChoSanPham %>" title="<%=Developer.ProductKeyword.ClickDeThemVideo %>" href="javascript:NewWindow_('cms/admin/Moduls/Product/Item/PopUp/AddVideoToItems.aspx?iid=<%#Eval("IID")%>','ImageList','1000','650','yes','yes')"><span class='iconThemVideo'>
                <!---->
              </span></a>
              <a class="<%=ProductConfig.KeyHienThiThemNhieuSubitemChoSanPham %>" title="<%=Developer.ProductKeyword.ClickDeThemSubitem %>" href="javascript:NewWindow_('cms/admin/Moduls/Product/Item/PopUp/AddSubitemToItems.aspx?iid=<%#Eval("IID")%>','ImageList','1000','650','yes','yes')"><span class='iconThemSubitem'>
                <!---->
              </span></a>
              <a class="<%=TagConfig.KeyHienThiTagChoProduct%>" title="<%=Developer.ProductKeyword.ClickDeThemTag %>" href="javascript:NewWindow_('cms/admin/TempControls/PopUp/Items/AddTags.aspx?iid=<%#Eval("IID")%>&Modul=<%=app %>','ImageList','1000','650','yes','yes')"><span class='iconThemTag'>
                <!---->
              </span></a>
              <div class="dn">
                <a title="<%=Developer.ProductKeyword.ClickDeThemVaoNhom %>" href="javascript:NewWindow_('cms/admin/Moduls/Product/Item/Popup/AddItemToGroups.aspx?iid=<%#Eval("IID")%>','ImageList','800','450','yes','yes')"><span class='iconThemVaoNhom'>
                  <!---->
                </span></a>
              </div>
...
<div id="SubItemSearch">
  ...
  <script type="text/javascript">
    $(window).load(function () {
      var height = ($("#ProductModul").outerHeight() + $("#SubItemSearch").outerHeight());
