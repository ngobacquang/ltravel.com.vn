<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuanLyBaiVietChoPheDuyet.ascx.cs" Inherits="cms_admin_Moduls_Product_Item_DuyetTin_QuanLyBaiVietChoPheDuyet" %>
