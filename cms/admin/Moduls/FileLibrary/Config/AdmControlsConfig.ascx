...
<div id="AdmControlsConfig">
  ...
  <div class="fl pl20 pt3">Số <%=Developer.FileLibraryKeyword.FileLibrary2 %> trên trang chủ:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoFileLibraryTrenTrangChu" Height="22" runat="server"></asp:TextBox>
  ...
  <div class="fl pl20 pt3">Số <%=Developer.FileLibraryKeyword.FileLibrary2 %> trên trang danh mục:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoFileLibraryTrenTrangDanhMuc" Height="22" runat="server"></asp:TextBox>
  ...
  <div class="fl pl20 pt3">Số <%=Developer.FileLibraryKeyword.FileLibrary2 %> khác trên một trang:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoFileLibraryKhacTrenMotTrang" Height="22" runat="server"></asp:TextBox>
