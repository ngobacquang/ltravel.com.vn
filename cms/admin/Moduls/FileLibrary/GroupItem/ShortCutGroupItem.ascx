...
<div id="admsccate">
  ...
  <div class="pdControl">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.FileLibraryKeyword.ViTri%></div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.FileLibraryKeyword.TenNhom %></div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.FileLibraryKeyword.SoFileLibraryDuocHienThi %>:</div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.FileLibraryKeyword.TrangThai %>:</div>
    </div>
    <div class="control">
      <div>
