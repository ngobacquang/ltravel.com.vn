...
public partial class cms_admin_Moduls_FileLibrary_Item_ShortCutItem : System.Web.UI.UserControl
{
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    ...
    if (!IsPostBack)
    {
      ltrTrangThai.Text = "<div class='text pt2'>" + Developer.FileLibraryKeyword.TrangThai + @"</div>";
  ...
  void InitialControlsValue(bool insert)
  {
    ...
    if (!insert)
    {
      ...
      #region Files
      if (dt.Rows[0][ItemsColumns.ViparamsColumn].ToString().Length > 0)
      {
        ltrFiles.Text = "Tệp hiện tại: <a href='" + TatThanhJsc.Extension.UrlExtension.WebisteUrl + pic + "/" +
                     dt.Rows[0][ItemsColumns.ViparamsColumn].ToString() + "' target='_blank'>" +
                     dt.Rows[0][ItemsColumns.ViparamsColumn].ToString() + "</a>";
      ...
      hdFile.Value = dt.Rows[0][ItemsColumns.ViparamsColumn].ToString();
