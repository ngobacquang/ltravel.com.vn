...
<div id="ShortCutCate">
  ...
  <div class="pdControl">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.NewKeyword.DanhMucCha %></div>
    </div>
    <div class="control">
      <asp:DropDownList ID="DdlGroupNew" runat="server" Width="252px"></asp:DropDownList>
    </div>
    <div class="cbh8">
      <!---->
    </div>
    <div class="text">
      <div class="pt8"><%=Developer.NewKeyword.TenDanhMuc%></div>
    </div>
    <div class="control">
      <asp:TextBox ID="txt_title_modul" runat="server" Width="600px" CssClass="tbTitle border-box px-4"></asp:TextBox>
    ...
    <div class="control">
      <asp:TextBox ID="txtDesc" runat="server" Width="600px" Height="50px" TextMode="MultiLine" CssClass="tbDesc border-box px-4"></asp:TextBox>
    </div>
    <div class="cbh8">
      <!---->
    </div>
