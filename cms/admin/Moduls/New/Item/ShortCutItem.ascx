...
<div id="admscitem">
  ...
  <div class="text">
    <div class="pt8"><%=NewKeyword.DanhMucCha%></div>
  </div>
  <div class="control">
  ...
  <div class="text">
    <div class="pt8"><%=NewKeyword.TieuDe%></div>
  </div>
  <div class="control">
  ...
  <div class="text">
    <div class="pt8"><%=NewKeyword.Ma%></div>
  </div>
  <div class="control">
  ...
  <div class="text">
    <div class="pt8"><%=NewKeyword.MoTa%></div>
  </div>
  <div class="box">
  ...
  <div class="text">
    <div class="pt8"><%=NewKeyword.NgayDang%></div>
  </div>
  <div>
  ...
  <div class="text">
    <div class="pt8"><%=NewKeyword.ThuTu%></div>
  </div>
  <div class="control">
  ...
  <div class="dn">
    ...
    <div class="text">
      <div class="pt8"><%=NewKeyword.DangBoi%></div>
    </div>
    <div>
  ...
  <div class="dn">
    ...
    <div class="text">
      <div class="pt8"><%=NewKeyword.MoTaHinhAnh%></div>
    </div>
    <div class="box">
  ...
  <div>
    <CKEditor:CKEditorControl ID="txt_content" runat="server" FilebrowserImageBrowseUrl="ckeditor/ckfinder/ckfinder.aspx?type=Images&path=pic/New"></CKEditor:CKEditorControl>
  </div>
  <div class="cbh10">
    <!---->
  </div>
  ...
  <div class="KhungToiUu PdKhungToiUu">
    ...
    <div>
      <div class="text">
        <div class="pt8"><%=NewKeyword.ToiUuTheTieuDe%> </div>
      </div>
      <div class="control1">
      ...
      <div class="text">
        <div class="pt8"><%=NewKeyword.ToiUuDuongDan%> </div>
      </div>
      <div class="control1">
      ...
      <div class="text">
        <div class="pt8"><%=NewKeyword.ToiUuTheTuKhoa%> </div>
      </div>
      <div class="control1">
      ...
      <div class="text">
        <div class="pt8"><%=NewKeyword.ToiUuTheMoTa%> </div>
      </div>
      <div class="control1">
        <asp:TextBox ID="textTagDescription" runat="server" Width="550px" Height="50px" TextMode="MultiLine" CssClass="tbDesc_Seo"></asp:TextBox>
      </div>
      ...
      <div class="dn">
        ...
        <div class="text">
          <div class="pt8"><%=NewKeyword.Tag%> </div>
        </div>
        <div class="control1">
