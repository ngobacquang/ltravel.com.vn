<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuanLyBaiVietBiHuy.ascx.cs" Inherits="cms_admin_Moduls_New_Item_DuyetTin_QuanLyBaiVietBiHuy" %>
...
<div id="admitem">
  ...
  <div class="BgTabTitle box-post" align="center">
    ...
    <div class="split">|</div>
    <div class="cot5"><%=Developer.NewKeyword.TrangThai %></div>
    <div class="split">|</div>
    <div class="fr pr5 cot7" align="right"><%=Developer.NewKeyword.CongCu %></div>
    <div class="cb">
      <!---->
    </div>
  </div>
