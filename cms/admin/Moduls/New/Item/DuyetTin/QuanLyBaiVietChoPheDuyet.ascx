<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuanLyBaiVietChoPheDuyet.ascx.cs" Inherits="cms_admin_Moduls_New_Item_DuyetTin_QuanLyBaiVietChoPheDuyet" %>
