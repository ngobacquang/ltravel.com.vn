...
<div id="AdmControlsConfig">
  ...
  <div class="fl pl20 pt3">Số <%=Developer.VideoKeyword.Video2 %> trên trang chủ:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoVideoTrenTrangChu" Height="22" runat="server"></asp:TextBox>
  ...
  <div class="fl pl20 pt3">Số <%=Developer.VideoKeyword.Video2 %> trên trang danh mục:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoVideoTrenTrangDanhMuc" Height="22" runat="server"></asp:TextBox>
  ...
  <div class="fl pl20 pt3">Số <%=Developer.VideoKeyword.Video2 %> khác trên một trang:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoVideoKhacTrenMotTrang" Height="22" runat="server"></asp:TextBox>
