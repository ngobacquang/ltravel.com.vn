        ...
        <div class="Item" id="Item-<%#Eval("IID").ToString()%>">
          <div class="bgItem box-post">
            ...
            <div class="fr tool pr5 box-cc cot7">
              <a class="<%=VideoConfig.KeyHienThiQuanLyPhanHoiVideo %> <%=keyHide %>" href="javascript:NewWindow_('cms/admin/Moduls/Video/Item/PopUp/ViewComments.aspx?iid=<%#Eval("IID")%>','ImageList','950','600','yes','yes')"><span class='iconPhanHoi'>
                <!---->
              </span></a>
              <div class="dn">
                <a class="<%=keyHide %>" title="<%=Developer.VideoKeyword.ClickDeThemVaoNhom %>" href="javascript:NewWindow_('cms/admin/Moduls/Video/Item/Popup/AddItemToGroups.aspx?iid=<%#Eval("IID")%>','ImageList','800','450','yes','yes')"><span class='iconThemVaoNhom'>
                  <!---->
                </span></a>
              </div>

              <a class="<%=TagConfig.KeyHienThiTagChoVideo%> <%=keyHide %>" title="Click để thêm tag" href="javascript:NewWindow_('cms/admin/TempControls/PopUp/Items/AddTags.aspx?iid=<%#Eval("IID")%>&Modul=<%=app %>','ImageList','950','600','yes','yes')"><span class='iconThemTag'>
                <!---->
              </span></a>
