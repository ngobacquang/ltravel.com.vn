...
<div id="ShortCutCate">
  ...
  <div class="pdControl">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.VideoKeyword.DanhMucCha %></div>
    </div>
    <div class="control">
      <asp:DropDownList ID="DdlGroupVideo" runat="server" Width="252px"></asp:DropDownList></div>
    <div class="cbh8">
      <!---->
    </div>
    <div class="text">
      <div class="pt8"><%=Developer.VideoKeyword.TenDanhMuc%></div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.VideoKeyword.MoTa%>:</div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.VideoKeyword.ThuTu %>:</div>
    </div>
    <div class="control">
    ...
    <div class="KhungToiUu PdKhungToiUu">
      ...
      <div>
        <div class="text">
          <div class="pt8"><%=Developer.VideoKeyword.ToiUuDuongDan%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.VideoKeyword.ToiUuTheTieuDe%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.VideoKeyword.ToiUuTheTuKhoa%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.VideoKeyword.ToiUuTheMoTa%>: </div>
        </div>
        <div class="control">
          <asp:TextBox ID="textTagDescription" runat="server" Width="550px" Height="50px" CssClass="tbDesc_Seo" TextMode="MultiLine"></asp:TextBox></div>
        <div class="cbh8">
          <!---->
        </div>
      </div>
    ...
    <div class="text">
      <div class="pt5"><%=Developer.VideoKeyword.TrangThai %>:</div>
    </div>
    <div class="control">
      <div>
