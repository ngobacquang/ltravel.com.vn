...
<div id="AdmControlsConfig">
  ...
  <div class="fl pl20 pt3">Số <%=Developer.DealKeyword.Deal2 %> trên trang chủ:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoDealTrenTrangChu" Height="22" runat="server"></asp:TextBox>
  ...
  <div class="fl pl20 pt3">Số <%=Developer.DealKeyword.Deal2 %> trên trang danh mục:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoDealTrenTrangDanhMuc" Height="22" runat="server"></asp:TextBox>
  ...
  <div class="fl pl20 pt3">Số <%=Developer.DealKeyword.Deal2 %> khác trên một trang:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoDealKhacTrenMotTrang" Height="22" runat="server"></asp:TextBox>
