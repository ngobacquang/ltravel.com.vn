...
<div id="admsccate">
  ...
  <div class="pdControl">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.DealKeyword.ViTri%></div>
    </div>
    <div class="control">
      <asp:DropDownList ID="DdlPosition" runat="server" Width="252px"></asp:DropDownList></div>
    <div class="cbh8">
      <!---->
    </div>
    <div class="text">
      <div class="pt8"><%=Developer.DealKeyword.TenNhom %></div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.DealKeyword.SoDealDuocHienThi %>:</div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.DealKeyword.TrangThai %>:</div>
    </div>
    <div class="control">
      <div>
