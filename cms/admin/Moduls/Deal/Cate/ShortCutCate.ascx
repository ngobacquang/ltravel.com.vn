...
<div id="admsccate">
  ...
  <div class="pdControl">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.DealKeyword.DanhMucCha %></div>
    </div>
    <div class="control">
      <asp:DropDownList ID="DdlGroupDeal" runat="server" Width="252px"></asp:DropDownList>
    </div>
    <div class="cbh8">
      <!---->
    </div>
    <div class="text">
      <div class="pt8"><%=Developer.DealKeyword.TenDanhMuc%></div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.DealKeyword.MoTa%>:</div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.DealKeyword.ThuTu %>:</div>
    </div>
    <div class="control">
    ...
    <div class="KhungToiUu PdKhungToiUu">
      ...
      <div>
        <div class="text">
          <div class="pt8"><%=Developer.DealKeyword.ToiUuDuongDan%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.DealKeyword.ToiUuTheTieuDe%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.DealKeyword.ToiUuTheTuKhoa%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.DealKeyword.ToiUuTheMoTa%>: </div>
        </div>
        <div class="control">
    ...
    <div class="text">
      <div class="pt5"><%=Developer.DealKeyword.TrangThai %>:</div>
    </div>
    <div class="control">
      <div>
