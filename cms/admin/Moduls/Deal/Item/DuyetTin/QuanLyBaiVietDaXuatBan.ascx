<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuanLyBaiVietDaXuatBan.ascx.cs" Inherits="cms_admin_Moduls_Deal_Item_DuyetTin_QuanLyBaiVietDaXuatBan" %>
...
<div id="admitem">
  ...
  <div class="BgTabTitle box-post" align="center">
    ...
    <div class="split">|</div>
    <div class="cot5"><%=Developer.DealKeyword.TrangThai %></div>
    <div class="split">|</div>
        ...
        <div class="Item" id="Item-<%#Eval("IID").ToString()%>">
          <div class="bgItem box-post">
            ...
            <div class="fr tool pr5 cot7 box-cc">
              <a class="<%=DealConfig.KeyHienThiQuanLyPhanHoiDeal %>" href="javascript:NewWindow_('cms/admin/Moduls/Deal/Item/PopUp/ViewComments.aspx?iid=<%#Eval("IID")%>','ImageList','950','600','yes','yes')"><span class='iconPhanHoi'>
                <!---->
              </span></a>
              <a class="<%=DealConfig.KeyHienThiThemNhieuAnhChoDeal %>" title="<%=Developer.DealKeyword.ClickDeThemHinhAnh %>" href="javascript:NewWindow_('cms/admin/Moduls/Deal/Item/PopUp/AddPictureToItems.aspx?iid=<%#Eval("IID")%>','ImageList','950','600','yes','yes')"><span class='iconThemAnh'>
                <!---->
              </span></a>
              <a class="<%=DealConfig.KeyHienThiThemNhieuVideoChoDeal %>" title="<%=Developer.DealKeyword.ClickDeThemVideo %>" href="javascript:NewWindow_('cms/admin/Moduls/Deal/Item/PopUp/AddVideoToItems.aspx?iid=<%#Eval("IID")%>','ImageList','950','600','yes','yes')"><span class='iconThemVideo'>
                <!---->
              </span></a>
              <a class="<%=DealConfig.KeyHienThiThemNhieuSubitemChoDeal %>" title="<%=Developer.DealKeyword.ClickDeThemSubitem %>" href="javascript:NewWindow_('cms/admin/Moduls/Deal/Item/PopUp/AddSubitemToItems.aspx?iid=<%#Eval("IID")%>','ImageList','950','600','yes','yes')"><span class='iconThemSubitem'>
                <!---->
              </span></a>
              <a class="<%=TagConfig.KeyHienThiTagChoDeal%>" title="Click để thêm tag" href="javascript:NewWindow_('cms/admin/TempControls/PopUp/Items/AddTags.aspx?iid=<%#Eval("IID")%>&Modul=<%=app %>','ImageList','950','600','yes','yes')"><span class='iconThemTag'>
                <!---->
              </span></a>
              <a title="<%=Developer.DealKeyword.ClickDeThemVaoNhom %>" href="javascript:NewWindow_('cms/admin/Moduls/Deal/Item/Popup/AddItemToGroups.aspx?iid=<%#Eval("IID")%>','ImageList','800','450','yes','yes')"><span class='iconThemVaoNhom'>
                <!---->
              </span></a>
...
<div id="SubItemSearch">
  ...
  <script type="text/javascript">
    $(window).load(function () {
      var height = ($("#DealModul").outerHeight() + $("#SubItemSearch").outerHeight());
