<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuanLyBaiVietChoPheDuyet.ascx.cs" Inherits="cms_admin_Moduls_Deal_Item_DuyetTin_QuanLyBaiVietChoPheDuyet" %>
