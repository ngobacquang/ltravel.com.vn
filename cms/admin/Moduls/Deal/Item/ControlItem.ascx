...
<cc1:StyleSheetCombiner ID="sheetCombiner" runat="server">
  <link href="~/cms/admin/Moduls/Deal/Item/ControlItem/_cs.css" rel="stylesheet" type="text/css" />
...
<div id="admitem">
  ...
  <div class="BgTabTitle box-post" align="center">
    ...
    <div class="split">|</div>
    <div class="fr pr5 cot7" align="right"><%=Developer.DealKeyword.CongCu %></div>
    <div class="cb">
      <!---->
    </div>
  </div>
        ...
        <div class="Item" id="Item-<%#Eval("IID").ToString()%>">
          <div class="bgItem box-post">
            ...
            <div class="fr tool pr5 cot7 box-cc">
              <div class="pb3">
                <a class="<%=DealConfig.KeyHienThiQuanLyPhanHoiDeal %> <%=keyHide %>" href="javascript:NewWindow_('cms/admin/Moduls/Deal/Item/PopUp/ViewComments.aspx?iid=<%#Eval("IID")%>','ImageList','950','600','yes','yes')"><span class='iconPhanHoi'>
                  <!---->
                </span></a>
                <a class="<%=DealConfig.KeyHienThiThemNhieuAnhChoDeal %> <%=keyHide %>" title="<%=Developer.DealKeyword.ClickDeThemHinhAnh %>" href="javascript:NewWindow_('cms/admin/Moduls/Deal/Item/PopUp/AddPictureToItems.aspx?iid=<%#Eval("IID")%>','ImageList','950','600','yes','yes')"><span class='iconThemAnh'>
                  <!---->
                </span></a>
                <a class="<%=DealConfig.KeyHienThiThemNhieuVideoChoDeal %> <%=keyHide %>" title="<%=Developer.DealKeyword.ClickDeThemVideo %>" href="javascript:NewWindow_('cms/admin/Moduls/Deal/Item/PopUp/AddVideoToItems.aspx?iid=<%#Eval("IID")%>','ImageList','950','600','yes','yes')"><span class='iconThemVideo'>
                  <!---->
                </span></a>
                <a class="<%=DealConfig.KeyHienThiThemNhieuSubitemChoDeal %> <%=keyHide %>" title="<%=Developer.DealKeyword.ClickDeThemSubitem %>" href="javascript:NewWindow_('cms/admin/Moduls/Deal/Item/PopUp/AddSubitemToItems.aspx?iid=<%#Eval("IID")%>','ImageList','950','600','yes','yes')"><span class='iconThemSubitem'>
                  <!---->
                </span></a>
                <a class="<%=TagConfig.KeyHienThiTagChoDeal%> <%=keyHide %>" title="Click để thêm tag" href="javascript:NewWindow_('cms/admin/TempControls/PopUp/Items/AddTags.aspx?iid=<%#Eval("IID")%>&Modul=<%=app %>','ImageList','950','600','yes','yes')"><span class='iconThemTag'>
                  <!---->
                </span></a>
              </div>

              <a class="<%=keyHide %>" title="<%=Developer.DealKeyword.ClickDeThemVaoNhom %>" href="javascript:NewWindow_('cms/admin/Moduls/Deal/Item/Popup/AddItemToGroups.aspx?iid=<%#Eval("IID")%>','ImageList','800','450','yes','yes')"><span class='iconThemVaoNhom'>
                <!---->
              </span></a>
            ...
            <div class="timeBorder dn">
              <div <%=SetEnableTime() %>>
                ...
                <div id='demnguoc<%#Eval("IID").ToString()%>' class="fl" align="left">
                  <b>Giời gian còn lại:</b> <span id='ngay<%#Eval("IID").ToString()%>'>
                    <!---->
                  </span>ngày <span id='gio<%#Eval("IID").ToString()%>'>
                    <!---->
                  </span>:<span id='phut<%#Eval("IID").ToString()%>'><!----></span>':<span id='giay<%#Eval("IID").ToString()%>'><!----></span>''
