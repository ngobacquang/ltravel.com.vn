<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuanLyBaiVietBiHuy.ascx.cs" Inherits="cms_admin_Moduls_Advertising_Item_DuyetTin_QuanLyBaiVietBiHuy" %>
...
<div id="admitem">
  ...
  <div class="BgTabTitle box-post" align="center">
    ...
    <div class="split">|</div>
    <div class="cot5"><%=Developer.AdvertisingKeyword.TrangThai %></div>
    <div class="split">|</div>
        ...
        <div class="Item" id="Item-<%#Eval("IID").ToString()%>">
          <div class="bgItem box-post">
            ...
            <div class="cot5" align="center">
              <a id="nc<%#Eval("IID").ToString()%>" title="<%=Developer.DuyetTinKeyword.YeuCauXetDuyetLai %>" href="javascript:UpdateEnableItemAdv('GuiYeuCauPheDuyetQuangCao', <%#Eval("IID").ToString()%>, '<%=status %>', '', '<%=app %>')" class="EnableIcon0">&nbsp;</a>
            </div>
            <div class="split">|</div>
