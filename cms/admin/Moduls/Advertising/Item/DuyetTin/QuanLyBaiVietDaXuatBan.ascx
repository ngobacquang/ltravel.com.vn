<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuanLyBaiVietDaXuatBan.ascx.cs" Inherits="cms_admin_Moduls_Advertising_Item_DuyetTin_QuanLyBaiVietDaXuatBan" %>
        ...
        <div class="Item" id="Item-<%#Eval("IID").ToString()%>">
          <div class="bgItem box-post">
            ...
            <div class="cot5" align="center">
              <a id="nc<%#Eval("IID").ToString()%>" title="<%=Developer.DuyetTinKeyword.GoBoQuangCao %>" href="javascript:UpdateEnableItemAdv('GoBoQuangCao', <%#Eval("IID").ToString()%>, '1', '', '<%=app %>')" class="EnableIcon<%#Eval("IIENABLE").ToString()%>">&nbsp;</a>
            </div>
            <div class="split">|</div>
