<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuanLyBaiVietChoPheDuyet.ascx.cs" Inherits="cms_admin_Moduls_Advertising_Item_DuyetTin_QuanLyBaiVietChoPheDuyet" %>
...
<div id="admitem">
  ...
  <div class="BgTabTitle box-post" align="center">
    ...
    <div class="split">|</div>
    <div class="cot5">
      <%=Developer.AdvertisingKeyword.TrangThai %>
    </div>
    <div class="split">|</div>
      ...
      <ItemTemplate>
        <div class="Item" id="Item-<%#Eval("IID").ToString()%>">
          <div class="bgItem box-post">
            ...
            <div class="split">|</div>
            <div class="cot5">
              <a id="nc<%#Eval("IID").ToString()%>" title="<%=Developer.DuyetTinKeyword.RutLaiYeuCauPheDuyet %>" href="javascript:UpdateEnableItemAdv('RutLaiQuangCao', <%#Eval("IID").ToString()%>, '1', '', '<%=app %>')" class="EnableIcon0">&nbsp;</a>
            </div>
            <div class="split">|</div>
