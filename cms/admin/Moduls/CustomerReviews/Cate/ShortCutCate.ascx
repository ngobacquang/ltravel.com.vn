...
<div id="ShortCutCate" class="InsertPanel InitQuikMenu">
  ...
  <div class="controlBox">
    ...
    <div class="row dn">
      ...
      <div class="pt10">
        <CKEditor:CKEditorControl ID="tbDetail" runat="server" FilebrowserImageBrowseUrl="ckeditor/ckfinder/ckfinder.aspx?type=Images&amp;path=pic/CustomerReviews"></CKEditor:CKEditorControl>
      </div>
    </div>
    <div class="h3"></div>
    <div class="KhungToiUu PdKhungToiUu">
      ...
      <div class="row">
        <div class="text"><%=Developer.CustomerReviewsKeyword.ToiUuDuongDan%></div>
        <div class="control">
          <asp:TextBox ID="tbSeoLink" runat="server" CssClass="tbLink_seo"></asp:TextBox>
        </div>
      </div>
      <div class="row">
        <div class="text"><%=Developer.CustomerReviewsKeyword.ToiUuTheTieuDe%></div>
        <div class="control">
          <asp:TextBox ID="tbSeoTitle" runat="server" CssClass="tbTitle_seo"></asp:TextBox>
        </div>
      </div>
      <div class="row">
        <div class="text"><%=Developer.CustomerReviewsKeyword.ToiUuTheTuKhoa%></div>
        <div class="control">
          <asp:TextBox ID="tbSeoKeyword" runat="server" CssClass="tbKeyword_seo"></asp:TextBox>
        </div>
      </div>
      <div class="row">
        <div class="text"><%=Developer.CustomerReviewsKeyword.ToiUuTheMoTa%></div>
        <div class="control">
    ...
    <div class="h15"></div>
    <div class="row">
      <div class="text pt2"><%=Developer.CustomerReviewsKeyword.TrangThai %></div>
      <div class="control">
