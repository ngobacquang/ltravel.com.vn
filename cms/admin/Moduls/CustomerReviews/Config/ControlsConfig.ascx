...
<div id="ControlsConfig">
  ...
  <div class="smalltextbox">
    <div class="fl pl20 pt3">Số <%= CustomerReviewsKeyword.CustomerReviews2 %> trên trang chủ:</div>
    <div class="fl pl10">
      <asp:TextBox ID="tbSoCustomerReviewsTrenTrangChu" Height="22" runat="server"></asp:TextBox>
    ...
    <div class="fl pl20 pt3">Số <%= CustomerReviewsKeyword.CustomerReviews2 %> trên trang danh mục:</div>
    <div class="fl pl10">
      <asp:TextBox ID="tbSoCustomerReviewsTrenTrangDanhMuc" Height="22" runat="server"></asp:TextBox>
    ...
    <div class="fl pl20 pt3">Số <%= CustomerReviewsKeyword.CustomerReviews2 %> khác trên một trang:</div>
    <div class="fl pl10">
      <asp:TextBox ID="tbSoCustomerReviewsKhacTrenMotTrang" Height="22" runat="server"></asp:TextBox>
  ...
  <div class="pl20 smalltextbox">
    ...
    <div class="khungThuocTinh">
      <div class="cot1 pb4">Ảnh làm dấu:</div>
      <div class="cot2">
        <div>
