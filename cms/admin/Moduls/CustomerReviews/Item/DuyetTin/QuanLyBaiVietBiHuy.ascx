<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuanLyBaiVietBiHuy.ascx.cs" Inherits="cms_admin_Moduls_CustomerReviews_Item_DuyetTin_QuanLyBaiVietBiHuy" %>
...
<div id="ControlItem">
  ...
  <div class="BgTabTitle box-post" align="center">
    ...
    <div class="split">|</div>
    <div class="cot5"><%=Developer.CustomerReviewsKeyword.TrangThai %></div>
    <div class="split">|</div>
