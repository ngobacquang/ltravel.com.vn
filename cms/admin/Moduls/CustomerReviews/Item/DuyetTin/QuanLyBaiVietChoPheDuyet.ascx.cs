...
public partial class cms_admin_Moduls_CustomerReviews_Item_DuyetTin_QuanLyBaiVietChoPheDuyet : System.Web.UI.UserControl
{
  ...
  {
    string key = tbKeySearch.Text + "&name=" + tbTitleSearch.Text;
    Response.Redirect(LinkAdmin.GoAdminCategory(app, "QuanLyBaiVietChoPheDuyet", ddlCateSearch.SelectedValue,
