...
<div id="ControlsConfig">
  ...
  <div class="smalltextbox">
    <div class="fl pl20 pt3">Số <%= TourKeyword.Tour2 %> trên trang chủ:</div>
    <div class="fl pl10">
      <asp:TextBox ID="tbSoTourTrenTrangChu" Height="22" runat="server"></asp:TextBox>
    ...
    <div class="fl pl20 pt3">Số <%= TourKeyword.Tour2 %> trên trang danh mục:</div>
    <div class="fl pl10">
      <asp:TextBox ID="tbSoTourTrenTrangDanhMuc" Height="22" runat="server"></asp:TextBox>
    ...
    <div class="fl pl20 pt3">Số <%= TourKeyword.Tour2 %> khác trên một trang:</div>
    <div class="fl pl10">
      <asp:TextBox ID="tbSoTourKhacTrenMotTrang" Height="22" runat="server"></asp:TextBox>
  ...
  <div class="pl20 smalltextbox">
    ...
    <div class="khungThuocTinh">
      Rộng
      <asp:TextBox ID="tbHanCheW" runat="server" ToolTip="Chiều rộng lớn nhất có thể của ảnh đại diện, nếu ảnh có kích thước lớn hơn nó sẽ tự co lại"></asp:TextBox>&nbsp;px&nbsp;&nbsp;&nbsp;
            Cao
      <asp:TextBox ID="tbHanCheH" runat="server" ToolTip="Chiều cao lớn nhất có thể của ảnh đại diện, nếu ảnh có kích thước lớn hơn nó sẽ tự co lại"></asp:TextBox>&nbsp;px
    </div>
    ...
    <div class="khungThuocTinh">
      Rộng
      <asp:TextBox ID="tbAnhNhoW" runat="server" ToolTip="Chiều rộng của ảnh nhỏ. Ảnh nhỏ dùng để hiển thị thay thế cho ảnh đại diện nhằm giảm tải dữ liệu phải tải về máy khách khi hiển thị"></asp:TextBox>&nbsp;px&nbsp;&nbsp;&nbsp;
            Cao
      <asp:TextBox ID="tbAnhNhoH" runat="server" ToolTip="Chiều cao của ảnh nhỏ. Ảnh nhỏ dùng để hiển thị thay thế cho ảnh đại diện nhằm giảm tải dữ liệu phải tải về máy khách khi hiển thị"></asp:TextBox>&nbsp;px
    </div>
  </div>
  ...
  <div class="pl20 pt5">
    <CKEditor:CKEditorControl ID="tbNoiDungCuoiDanhSach" runat="server" FilebrowserImageBrowseUrl="ckeditor/ckfinder/ckfinder.aspx?type=Images&path=pic/tour" Height="250px"></CKEditor:CKEditorControl>
  </div>
  <div class="cb h20">
    <!---->
  </div>
  <div class="pl20">Thông báo đặt tour thành công:</div>
  <div class="pl20 pt5">
    <CKEditor:CKEditorControl ID="tbThongBaoDatTourThanhCong" runat="server" FilebrowserImageBrowseUrl="ckeditor/ckfinder/ckfinder.aspx?type=Images&path=pic/tour" Height="250px"></CKEditor:CKEditorControl>
  </div>
  <div class="cb h20">
    <!---->
  </div>
