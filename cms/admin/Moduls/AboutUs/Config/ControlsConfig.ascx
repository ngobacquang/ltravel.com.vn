...
<div id="ControlsConfig">
  ...
  <div class="smalltextbox">
    <div class="fl pl20 pt3">Số <%= AboutUsKeyword.AboutUs2 %> trên trang chủ:</div>
    <div class="fl pl10">
      <asp:TextBox ID="tbSoAboutUsTrenTrangChu" Height="22" runat="server"></asp:TextBox>
    ...
    <div class="fl pl20 pt3">Số <%= AboutUsKeyword.AboutUs2 %> trên trang danh mục:</div>
    <div class="fl pl10">
      <asp:TextBox ID="tbSoAboutUsTrenTrangDanhMuc" Height="22" runat="server"></asp:TextBox>
    ...
    <div class="fl pl20 pt3">Số <%= AboutUsKeyword.AboutUs2 %> khác trên một trang:</div>
    <div class="fl pl10">
      <asp:TextBox ID="tbSoAboutUsKhacTrenMotTrang" Height="22" runat="server"></asp:TextBox>
