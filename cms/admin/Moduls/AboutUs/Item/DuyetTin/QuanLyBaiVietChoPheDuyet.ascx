<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuanLyBaiVietChoPheDuyet.ascx.cs" Inherits="cms_admin_Moduls_AboutUs_Item_DuyetTin_QuanLyBaiVietChoPheDuyet" %>
...
<div id="ControlItem">
  ...
  <div class="BgTabTitle box-post" align="center">
    ...
    <div class="split">|</div>
    <div class="cot5">
      <%=Developer.AboutUsKeyword.TrangThai %>
    </div>
    <div class="split">|</div>
