<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuanLyBaiVietBiHuy.ascx.cs" Inherits="cms_admin_Moduls_AboutUs_Item_DuyetTin_QuanLyBaiVietBiHuy" %>
...
<style>
  .iconPhanHoi{background:url(./cms/admin/cs/AllModul/CommentIcon.png) no-repeat}
</style>
...
<div id="ControlItem">
  ...
  <div class="BgTabTitle box-post" align="center">
    ...
    <div class="split">|</div>
    <div class="cot3">
      <asp:LinkButton ID="lbtDate" runat="server" OnClick="lbtDate_Click" CssClass="arrowSort" ToolTip="Click để sắp xếp danh sách theo trường này"><%=Developer.DuyetTinKeyword.NgayHuy %></asp:LinkButton>
    </div>
    <div class="split">|</div>
    <div class="cot3"><%=Developer.DuyetTinKeyword.NguoiHuy %></div>
    <div class="split">|</div>
    <div class="cot5"><%=Developer.AboutUsKeyword.TrangThai %></div>
    <div class="split">|</div>
      ...
      <ItemTemplate>
        <div class="Item" id="Item-<%#Eval("IID").ToString()%>">
          <div class="bgItem box-post">
            ...
            <div class="split">|</div>
            <div class="cot3"><%#StringExtension.LayChuoi(Eval("VISEOMETACANONICAL").ToString(), "", 1) %></div>
            <div class="split">|</div>
            <div class="cot5" align="center">
              <a id="nc<%#Eval("IID").ToString()%>" title="<%=Developer.DuyetTinKeyword.YeuCauXetDuyetLai %>" href="javascript:UpdateEnableItemNew('GuiYeuCauPheDuyetBaiViet', <%#Eval("IID").ToString()%>, '<%=status %>', '', '<%=app %>')" class="EnableIcon0">&nbsp;</a>
            </div>
            <div class="split">|</div>
            <div class="fr tool pr5 cot7 box-cc">
              <a title="<%=Developer.DuyetTinKeyword.XemLoiNhan %>" href="javascript:jAlert('<%#StringExtension.LayChuoi(Eval("VISEOMETACANONICAL").ToString(), "", 2) %>', '<%=Developer.DuyetTinKeyword.LoiNhan %>')"><span class='iconPhanHoi'>
                <!---->
              </span></a>
              &nbsp;&nbsp;
...
<div id="SubItemSearch">
  ...
  <script type="text/javascript">
    $(window).load(function () {
      var height = ($("#AboutUsModul").outerHeight() + $("#SubItemSearch").outerHeight());
