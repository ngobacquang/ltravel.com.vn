<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuanLyBaiVietDaXuatBan.ascx.cs" Inherits="cms_admin_Moduls_AboutUs_Item_DuyetTin_QuanLyBaiVietDaXuatBan" %>
