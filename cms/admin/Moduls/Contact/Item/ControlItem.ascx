...
<div id="admitem">
  ...
  <div class="BgTabTitle box-post" align="center">
    ...
    <div class="split">|</div>
    <div class="fr pr5 cot7" align="right"><%=Developer.ContactKeyword.CongCu %></div>
    <div class="cb">
      <!---->
    </div>
  </div>
        ...
        <div id="Item-<%#Eval("IID").ToString()%>">
          <div class="bgItem box-post">
            ...
            <div class="cot2" align="left">
              ...
              <div class="pt5 dn">- <b>Địa chỉ:</b> <%#StringExtension.LayChuoi(Eval("VIPARAMS").ToString(),"",2)%></div>
            ...
            <div class="fr tool pr5 cot7 box-cc">
              <a title='Click để xem chi tiết thư liên hệ này' href="javascript:void(0)" onclick="NewWindow_('cms/admin/Moduls/Contact/Item/Popup/ViewDetail.aspx?iid=<%#Eval("IID")%>','ImageList','900','500','yes','yes')"><span class='iconInfo'>
                <!---->
              </span></a>
