...
<div id="admsccate">
  ...
  <div class="pdControl">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.ContactKeyword.DanhMucCha %></div>
    </div>
    <div class="control">
      <asp:DropDownList ID="DdlGroupContactUs" runat="server" Width="252px"></asp:DropDownList>
    </div>
    <div class="cbh8">
      <!---->
    </div>
    <div class="text">
      <div class="pt8"><%=Developer.ContactKeyword.TieuDeNhom %></div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.ContactKeyword.DiaChi %></div>
    </div>
    <div class="control">
      <asp:TextBox ID="tbDiaChi" runat="server" Width="603px"></asp:TextBox>
    </div>
    <div class="cbh8">
      <!---->
    </div>
    <div class="text">
      <div class="pt8"><%=Developer.ContactKeyword.DienThoai %></div>
    </div>
    <div class="control">
      <asp:TextBox ID="tbDienThoai" runat="server" Width="603px"></asp:TextBox>
    </div>
    ...
    <div class="dn">
      ...
      <div class="text">
        <div class="pt8"><%=Developer.ContactKeyword.Fax %></div>
      </div>
      <div class="control">
        <asp:TextBox ID="tbFax" runat="server" Width="603px"></asp:TextBox>
      </div>
    </div>
    ...
    <div class="text">
      <div class="pt8"><%=Developer.ContactKeyword.Email %></div>
    </div>
    <div class="control">
      <asp:TextBox ID="tbEmail" runat="server" Width="603px"></asp:TextBox>
    </div>
    <div class="cbh8">
      <!---->
    </div>
    <div class="text">
      <div class="pt8">Website</div>
    </div>
    <div class="control">
      <asp:TextBox ID="tbWebsite" runat="server" Width="603px"></asp:TextBox>
    </div>
    <div class="dn">
      <div class="cbh8">
        <!---->
      ...
      <div class="text">
        <div class="pt8">Hotline</div>
      </div>
      <div class="control">
        <asp:TextBox ID="tbHotline" runat="server" Width="603px"></asp:TextBox>
      </div>
    </div>
    ...
    <div class="text">
      <div class="pt8">Mã nhúng Goole map:</div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.ContactKeyword.ThuTu %>:</div>
    </div>
    <div class="control">
    ...
    <div class="">
      ...
      <div class="KhungToiUu PdKhungToiUu">
        ...
        <div>
          <div class="text">
            <div class="pt8"><%=Developer.ContactKeyword.ToiUuDuongDan%>: </div>
          </div>
          <div class="control">
          ...
          <div class="text">
            <div class="pt8"><%=Developer.ContactKeyword.ToiUuTheTieuDe%>: </div>
          </div>
          <div class="control">
          ...
          <div class="text">
            <div class="pt8"><%=Developer.ContactKeyword.ToiUuTheTuKhoa%>: </div>
          </div>
          <div class="control">
          ...
          <div class="text">
            <div class="pt8"><%=Developer.ContactKeyword.ToiUuTheMoTa%>: </div>
          </div>
          <div class="control">
    ...
    <div class="text">
      <div class="pt5"><%=Developer.ContactKeyword.TrangThai %>:</div>
    </div>
    <div class="control">
      <div>
