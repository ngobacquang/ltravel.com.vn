...
<div id="AdmControlsConfig">
  ...
  <div class="fl pl20 pt3">Số <%=Developer.QAKeyword.QA2 %> trên trang chủ:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoQATrenTrangChu" Height="22" runat="server"></asp:TextBox>
  ...
  <div class="fl pl20 pt3">Số <%=Developer.QAKeyword.QA2 %> trên trang danh mục:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoQATrenTrangDanhMuc" Height="22" runat="server"></asp:TextBox>
  ...
  <div class="fl pl20 pt3">Số <%=Developer.QAKeyword.QA2 %> khác trên một trang:</div>
  <div class="fl pl10">
    <asp:TextBox ID="tbSoQAKhacTrenMotTrang" Height="22" runat="server"></asp:TextBox>
  ...
  <div class="dn">
    ...
    <asp:Panel ID="pnCauHinhTrangChu" runat="server" CssClass="pl20">
      <div class="khungThuocTinh">
        <asp:Panel ID="Panel1" runat="server" CssClass="pb5 dn flex-center">
