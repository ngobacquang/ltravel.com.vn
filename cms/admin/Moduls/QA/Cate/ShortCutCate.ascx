...
<div id="ShortCutCate">
  ...
  <div class="pdControl">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.QAKeyword.DanhMucCha %></div>
    </div>
    <div class="control">
      <asp:DropDownList ID="DdlGroupQA" runat="server" Width="252px"></asp:DropDownList>
    </div>
    <div class="cbh8">
      <!---->
    </div>
    <div class="text">
      <div class="pt8"><%=Developer.QAKeyword.TenDanhMuc%></div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.QAKeyword.MoTa%>:</div>
    </div>
    <div class="control">
    ...
    <div class="text">
      <div class="pt8"><%=Developer.QAKeyword.ThuTu %>:</div>
    </div>
    <div class="control">
    ...
    <div class="KhungToiUu PdKhungToiUu">
      ...
      <div>
        <div class="text">
          <div class="pt8"><%=Developer.QAKeyword.ToiUuDuongDan%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.QAKeyword.ToiUuTheTieuDe%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.QAKeyword.ToiUuTheTuKhoa%>: </div>
        </div>
        <div class="control">
        ...
        <div class="text">
          <div class="pt8"><%=Developer.QAKeyword.ToiUuTheMoTa%>: </div>
        </div>
        <div class="control">
    ...
    <div class="text">
      <div class="pt5"><%=Developer.QAKeyword.TrangThai %>:</div>
    </div>
    <div class="control">
      <div>
