...
public partial class cms_display_Banner_ChonNgonNgu : System.Web.UI.UserControl
{
  private string top = "";
  ...
  {
    TatThanhJsc.LanguageModul.Cookie.SetLanguageValueDisplay(languageId);
  }

  protected string SetCurrentLanguage(string languageId)
  {
    if (languageId == TatThanhJsc.LanguageModul.Cookie.GetLanguageValueDisplay())
      return "Current";
    else
      return "";
  }
